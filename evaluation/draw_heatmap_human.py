...
def heatmap(data, row_labels, col_labels, ax=None,
    ...
    **kwargs
    ...
    # Plot the heatmap
    im = ax.imshow(data, vmin=1, vmax=5, **kwargs)
...
llms = ["Tongyi Qianwen (CT)", "ERNIE Bot (CT)", "ChatGPT (CT)", "Bard (CT)"," ","Tongyi Qianwen (PET-CT)", "ERNIE Bot (PET-CT)", "ChatGPT (PET-CT)", "Bard (PET-CT)"," ","Tongyi Qianwen (US)", "ERNIE Bot (US)", "ChatGPT (US)", "Bard (US)"]

file_name = 'All_qing'

values = pd.read_excel("human_eval_fig\{}.xlsx".format(file_name))
...
fig.savefig('human_eval_fig\{}.pdf'.format(file_name),dpi=600,format='pdf',bbox_inches='tight')
